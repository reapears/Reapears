//! Email sent to user on password reset
...
pub fn password_reset_email(
    ...
    let text = password_reset_email_text(first_name, link);
    let html = password_reset_email_html(first_name, link);
    EmailMessage::from_outlook(user_email, subject, text, html)
}

/// Reset password email
fn password_reset_email_text(first_name: &str, link: &str) -> String {
    format!(
        "
Hey {first_name}!
...
fn password_reset_email_html(first_name: &str, link: &str) -> String {
    format!(
        r##"
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                ...
                                                <p
                                                    style="font-family: -apple-system,BlinkMacSystemFont, &quot;Segoe UI&quot;,Helvetica,Arial,sans-serif,&quot;Apple Color Emoji&quot;,&quot;Segoe UI Emoji&quot; !important;">
                                                    A request has been received to change the password for your Reapears account</p>
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
